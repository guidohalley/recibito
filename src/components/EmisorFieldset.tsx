...
export default function EmisorFieldset({ register, errors, setValue }: Props) {
  ...
  return (
    <fieldset className="border border-gray-700 p-4 rounded">
      ...
      {/* Selector */}
      <div className="mt-2">
        <label className="block text-gray-300">Seleccionar emisor</label>
        <div className="relative group">
          ...
          >
            <Select.Trigger
              className="w-full pl-3 pr-8 p-2 border border-gray-700 rounded bg-gray-800 text-white text-left flex items-center focus:outline-none focus:ring-2 focus:ring-blue-500 transition relative hover:border-blue-500 group-hover:border-blue-500"
            ...
            <Select.Content className="bg-gray-900 text-white rounded shadow-xl border border-gray-700 mt-1 z-50 animate-fade-in overflow-hidden">
              <Select.Viewport className="py-1">
                <Select.Item value="otro" className="px-4 py-2 hover:bg-blue-600 hover:text-white cursor-pointer rounded transition-colors">
